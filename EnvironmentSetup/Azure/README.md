...
**Step 1.** Change your directory to the directory containing `docker-compose.yml` directory and enter your tenant id then run the following command to set up AKS and deploy WAS:
...
**Step 3.** After completion, run this command to shutdown the azure-setup-manager:
